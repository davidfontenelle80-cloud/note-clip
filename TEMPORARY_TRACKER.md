...
Tasks:
- Move category modal workflow into source code.
- Ensure Add/Edit Category DOM order is: Category Name, Category Icon, icon picker, actions.
- Remove forced scroll/focus behavior after icon tap.
- Keep icon selection updating hidden input, selected class, and preview.
...
- `sw.js` currently contains temporary UI hotfix injection for category modal and bottom-nav selected dot.
- Recent commits:
