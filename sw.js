const CACHE_VERSION = 'note-clip-v106-category-note-context';
...
function patchInjectedStyles(html) {
  ...
  html = html.replace(/<link id="noteclip-category-card-pastel"[^>]*>/g, '');
  ...
  html = html.replace(/<script id="noteclip-category-color-true-match"[^>]*><\/script>/g, '');
  html = html.replace(/<script id="noteclip-category-color-safe-picker"[^>]*><\/script>/g, '');
  html = html.replace(/<script id="noteclip-category-note-context"[^>]*><\/script>/g, '');
  html = html.replace(/<script id="noteclip-category-card-add-menu"[^>]*><\/script>/g, '');
  html = html.replace(/<script id="noteclip-category-back-button-polish"[^>]*><\/script>/g, '');
